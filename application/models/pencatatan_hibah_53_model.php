...
class pencatatan_hibah_53_model extends CI_Model {
	...
	public function listing() {
		...
		$this->db->from('pencatatan_hibah_53');
		// Join
	...
	// 	$this->db->order_by('id_pencatatan_hibah_53','DESC');
	// 	$this->db->limit(6);
	// 	$query = $this->db->get();
	// 	return $query->result();
	// }
	...
	public function detail($id_pencatatan_hibah){
		$query = $this->db->get_where('pencatatan_hibah_53',array('id_pencatatan_hibah'  => $id_pencatatan_hibah));
		return $query->row();
	}
	
	// Post
	public function post ($data) {
		$this->db->insert('pencatatan_hibah_53',$data);
	}
	
	// Edit 
	public function edit ($data) {
		$this->db->where('id_pencatatan_hibah',$data['id_pencatatan_hibah']);
		$this->db->update('pencatatan_hibah_53',$data);
	}
	
	// Delete
	public function delete ($data){
		$this->db->where('id_pencatatan_hibah',$data['id_pencatatan_hibah']);
		$this->db->delete('pencatatan_hibah_53',$data);
	}
}