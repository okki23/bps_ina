...
class Surat_masuk extends CI_Controller {
	var $folder =   "surat_masuk";
    var $tables =   "surat_masuk";
    var $pk     =   "id_surat_masuk";
	...
	public function index() {
		$surat_masuk = $this->surat_masuk_model->listing();
		$data = array('surat_masuk'	=> $surat_masuk);
	...
	public function tambah() {
		...
		$v->set_rules('tgl_diterima','Golongan','', array('required'=> 'Golongan harus diisi'));
		...
		// Masuk database
			...
			$config['source_image'] 	= './assets/upload/surat_masuk/'.$upload_data['uploads']['file_name']; 
			$config['new_image'] 		= './assets/upload/surat_masuk/thumbs/';
			...
			$this->surat_masuk_model->tambah($data);
	...
	public function edit($id_surat_masuk) {
		$surat_masuk		= $this->surat_masuk_model->detail($id_surat_masuk);
		...
		// Masuk database
			...
			// Proses ke database
			$i = $this->input;
			$data = array(	'id_surat_masuk'		=> $id_surat_masuk,
			...
			$this->surat_masuk_model->edit($data);
