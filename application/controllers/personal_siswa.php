...
class personal_siswa extends CI_Controller{
    ...
    function index()
    {
       if(isset($_POST['submit']))
		...
		$query  =  "SELECT * FROM registrasi WHERE tahun_pendaftaran like '$tahun_pendaftaran' AND kd_unit='$kd_unit' AND status_pendaftaran='Lulus' ORDER BY id_registrasi ";
