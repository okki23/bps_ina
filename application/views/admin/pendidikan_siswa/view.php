	...
	<div class="panel panel-inverse">
		...
		<?php echo form_open('admin/pendidikan_siswa'); ?>
			<div class="container">
	...
	<?php if(isset($_POST['submit'])) { ?>
		...
		<p>
			<a href="<?php echo base_url('admin/pendidikan_siswa/post') ?>" class="btn btn-primary">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div align="center">
					<a href="<?php echo base_url('admin/pendidikan_siswa/edit/'.$r->id_pendidikan_siswa) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
