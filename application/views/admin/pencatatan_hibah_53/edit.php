	...
	<div class="panel panel-inverse">
		...
		<?php
			...
			// Validasi
				...
				echo form_open_multipart('admin/pencatatan_hibah_53/edit/'.$pencatatan_hibah_53->id_pencatatan_hibah);	
					...
					<div class="col-xl-8 offset-xl-2">
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Nama Barang</label>
								<div class="col-lg-9 col-xl-6">
									<input type="text" name="nama_barang" class="form-control" value="<?php echo $pencatatan_hibah_53->nama_barang ?>" required>	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Nilai Barang</label>
								<div class="col-lg-9 col-xl-6">
									<input type="text" name="nilai_barang" class="form-control" value="<?php echo $pencatatan_hibah_53->nilai_barang ?>" required>	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Nama Penerima</label>
								<div class="col-lg-9 col-xl-6">
									<input type="text" name="nama_penerima" class="form-control" value="<?php echo $pencatatan_hibah_53->nama_penerima ?>" required>
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Status</label>
								<div class="col-lg-9 col-xl-6">
									<textarea name='status' class="form-control" rows="3"><?php echo $pencatatan_hibah_53->status ?></textarea>		
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Surat Usulan Penetapan Status Penggunaan BMN</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_1" class="form-control" value="<?php echo $pencatatan_hibah_53->file_1 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">SK. Penetapan Status Penggunaan BMN</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_2" class="form-control" value="<?php echo $pencatatan_hibah_53->file_2 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">BAST. Pihak Pemberi & Penerima</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_3" class="form-control" value="<?php echo $pencatatan_hibah_53->file_3 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Surat Pernyataan Bersedia Menerima Hibah</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_4" class="form-control" value="<?php echo $pencatatan_hibah_53->file_4 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Foto / Dokumentasi Hibah</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_5" class="form-control" value="<?php echo $pencatatan_hibah_53->file_5 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Fotokopi POK/DIPA</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_6" class="form-control" value="<?php echo $pencatatan_hibah_53->file_6 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Surat Usulan Permohonan Persetujuan Hibah</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_7" class="form-control" value="<?php echo $pencatatan_hibah_53->file_7 ?>">	
								</div>
						</div>

						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">SK. Pembentukan TIM Internah Hibah</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_8" class="form-control" value="<?php echo $pencatatan_hibah_53->file_8 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Berita Acara Penelitian</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_9" class="form-control" value="<?php echo $pencatatan_hibah_53->file_9 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Surat Pernyataan</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_10" class="form-control" value="<?php echo $pencatatan_hibah_53->file_10 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Surat Pernyataan Tanggung Jawab</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_11" class="form-control" value="<?php echo $pencatatan_hibah_53->file_11 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Alasan Hibah</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_12" class="form-control" value="<?php echo $pencatatan_hibah_53->file_12 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Naskah Hibah yang Ditanda Tangani</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_13" class="form-control" value="<?php echo $pencatatan_hibah_53->file_13 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">BAST Akhir yang Ditanda Tangani</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_14" class="form-control" value="<?php echo $pencatatan_hibah_53->file_14 ?>">	
								</div>
						</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-left col-form-label">Surat Usulan Permohonan SK. Penghapusan Hibah</label>
								<div class="col-lg-9 col-xl-6">
									<input type="file" name="file_15" class="form-control" value="<?php echo $pencatatan_hibah_53->file_15 ?>">	
								</div>
						</div>
