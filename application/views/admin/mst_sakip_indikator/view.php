	...
	<div class="panel panel-inverse">
		...
		<p>
			<a href="<?php echo base_url('admin/mst_sakip_indikator/post') ?>" class="btn btn-primary">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div align="center">
					<a href="<?php echo base_url('admin/mst_sakip_indikator/edit/'.$r->id_indikator) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
