	...
	<div class="panel-body">
		...
		?>
		<?php
			echo form_open_multipart('admin/mst_sakip_indikator/edit');	
			echo "<input type='hidden' name='id' value='$r[id_indikator]'>";
		?>
		...
		<fieldset>
				<div class="row">
					<div class="col-xl-8 offset-xl-2">
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-right col-form-label">INDIKATOR</label>
								<div class="col-lg-9 col-xl-6">
									<?php echo inputan('text', 'indikator','','', 1, $r['indikator'],'');?>
								</div>
						</div>
						<div class="form-group row m-b-10">
