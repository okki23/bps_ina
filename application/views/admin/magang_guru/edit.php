	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
			...
			<?php
				...
				echo form_open_multipart('admin/magang_guru/edit');
				echo "<input type='hidden' name='id' value='$r[id_magang]'>";
				
			?>
			
			<input type='hidden' name='nip' value="<?php echo $r['nip'];?>">
			<input type='hidden' name='nama' value="<?php echo $r['nama'];?>">
			<input type='hidden' name='kd_unit' value="<?php echo $r['kd_unit'];?>">
