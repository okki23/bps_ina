...
<div class="profile-content">
	<div class="tab-content p-0">
		<div class="tab-pane fade show active" id="profile-post">
			...
			<a href="<?php echo base_url().'admin/guru/post/'.$r['nipbaru'].'/'.$r['NIP'] ;?>" class="btn btn-primary btn-sm">
				 ...
				 <?php
					...
					<small>
						<tr class="font-size-sm text-muted">
							...
							<td>
								<a href="<?php echo base_url().'admin/personal_guru/edit/'.$bahan['id_personal_guru'];?>" class="btn btn-warning btn-sm">
									<i class="fa fa-edit"></i>
								</a>
								<a href="<?php echo base_url().'admin/personal_guru/delete/'.$bahan['id_personal_guru'];?>" class="btn btn-danger btn-sm">
		...
		<div class="tab-pane fade" id="profile-friend">
			...
			<a href="<?php echo base_url().'admin/magang_guru/post/'.$r['nipbaru'].'/'.$r['NIP'] ;?>" class="btn btn-primary btn-sm">
				<i class="fa fa-plus"></i>
			</a>		
			<hr>
			<table id="example1" class="table table-bordered table-striped">
				 ...
				 <?php
					...
					<small>
						<tr class="font-size-sm text-muted">
							...
							<td>
								<a href="<?php echo base_url().'admin/magang_guru/edit/'.$mgg['id_magang'];?>" class="btn btn-warning btn-sm">
									<i class="fa fa-edit"></i>
								</a>
								<a href="<?php echo base_url().'admin/magang_guru/delete/'.$mgg['id_magang'];?>" class="btn btn-danger btn-sm">
									<i class="fa fa-trash"></i>
								</a>
							</td>
						</tr>  
