	...
	<div class="panel panel-inverse">
		...
		<?php echo form_open('admin/serapan_alumni'); ?>
			<div class="container">
	...
	<?php if(isset($_POST['submit'])) { ?>
		...
		<p>
			<a href="<?php echo base_url('admin/serapan_alumni/post') ?>" class="btn btn-primary">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div align="center">
					<a href="<?php echo base_url('admin/serapan_alumni/edit/'.$r->id_serapan_alumni) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
