	...
	<div class="panel panel-inverse">
		...
		<p>
			<a href="<?php echo base_url('admin/ruang_rapat/post') ?>" class="btn btn-primary" style="background-color: #394384; color: #FFFFFF; border-radius: 20px;">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div align="center">
					<a href="<?php echo base_url('admin/ruang_rapat/edit/'.$r->id_ruangan) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
				</div>
