	...
	<div class="panel panel-inverse">
		...
		<?php
			echo form_open_multipart('admin/ruang_rapat/post');	
		?>
		<?php 
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-right col-form-label">Nama Ruangan</label>
								<div class="col-lg-9 col-xl-6">
									<select class="default-select2 form-control" name='nama_ruangan'>
										<?php
											$nama_ruangan= isset($_GET['nama_ruangan']) ? $_GET['nama_ruangan'] : '';
											$b="SELECT nama_ruangan FROM mst_ruang_rapat ";
											$s=mysql_query($b);
											while($don=mysql_fetch_array($s)){
										?>									
										<option value="<?php echo $don['nama_ruangan']?>"><?php echo $don['nama_ruangan'];?></option>
										<?php
											}
										?>
									</select>
