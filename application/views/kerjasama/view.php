	...
	<div class="panel panel-inverse">
		...
		<p>
			<a href="<?php echo base_url('kerjasama/post') ?>" class="btn btn-primary">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div align="center">
					<a href="<?php echo base_url('kerjasama/edit/'.$r->id_kerjasama) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
