					...
					<div class="col-xl-8 offset-xl-2">
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-right col-form-label">Merk Barang</label>
								<div class="col-lg-9 col-xl-6">
									<input type="text" name='merk_barang' placeholder="" class="form-control"/>
								</div>
						</div>
									...
									<div class="row row-space-6">
										<div class="col-4">
											<select class="form-control" name='tahun_pembelian'>
												<?php for($i=date('Y'); $i>=date('Y')-12; $i-=1){ echo"<option value='$i'> $i </option>";  } ?>
											</select>
										</div>		
									</div>
								</div>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-right col-form-label">Nilai Barang</label>
								<div class="col-lg-9 col-xl-6">
									<input type="text" name='nilai_barang' placeholder="Diisi Jika Ada" class="form-control"/>
								</div>
						</div>
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-right col-form-label">Lokasi Barang</label>
								<div class="col-lg-9 col-xl-6">
									<input type="text" name='lokasi_barang' placeholder="Diisi Jika Ada" class="form-control"/>
								</div>
						</div>
						<div class="form-group row m-b-10">
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-3 text-lg-right col-form-label">Keluhan Kondisi Barang</label>
								<div class="col-lg-9 col-xl-6">
									<input type="text" name='keluhan_kondisi_barang' placeholder="Diisi Jika Ada" class="form-control"/>
								</div>
						</div>
