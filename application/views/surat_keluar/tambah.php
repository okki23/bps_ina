	...
	<div class="panel panel-inverse">
		...
		<?php
			...
			// Validasi
				...
				// Form
				echo form_open_multipart('surat_keluar/tambah');
							...
							<label class="col-lg-3 text-lg-right col-form-label">Asal Surat</label>
								<div class="col-lg-9 col-xl-6">
									<select name="asal_surat" class="form-control">
										<option value="Sekretaris Badan Pengembangan Sumber Daya Manusia Industri">Sekretaris Badan Pengembangan Sumber Daya Manusia Industri</option>
										<option value="Kepala Pusat Pendidikan dan Pelatihan Industri">Kepala Pusat Pendidikan dan Pelatihan Industri</option>
										<option value="Kepala Pusat Pengembangan Pendidikan Kejuruan dan Vokasi Industri">Kepala Pusat Pengembangan Pendidikan Kejuruan dan Vokasi Industri</option>
									</select>
								</div>
						</div>
