	...
	<div class="panel panel-inverse">
		...
		?>
		<p>
			<a href="<?php echo base_url('surat_keluar/tambah') ?>" class="btn btn-primary">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
						<?php 	$i=1; foreach ($surat_keluar as $r)
							{
						?>
						<tr>
							...
							<b>File : </b><i><a href='".base_URL()."assets/upload/surat_keluar/".$r->gambar."' target='_blank'>".$r->gambar."</a>"?></td>
							
							<td width="5%"><?php echo $r->asal_surat;?></td>
							<td width="5%"><?php echo $r->no_surat;?></td>
							<td width="8%"> <?php echo tgl_indo($r->tgl_surat);?></td>
							<td width="8%"> <?php echo $r->tujuan;?></td>
							<td width="5%"><?php echo $r->keterangan;?></td>
	
							</td>
							<td width="5%">
								<div align="center">
									<a href="<?php echo base_url('surat_keluar/edit/'.$r->id_surat_keluar) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
