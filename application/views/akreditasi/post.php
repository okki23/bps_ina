								...
								<div class="col-lg-9 col-xl-6">
									<select class="form-control" id="nama_prodi" name='nama_prodi' >
										<?php
											...
											$b="SELECT id_prodi, nama_prodi FROM prodi WHERE kd_unit='$kd_unit' ";
											$s=mysql_query($b);
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-4 text-lg-right col-form-label">Tahun Akreditasi</label>
								<div class="col-lg-9 col-xl-3">
									<input type="text" name='tahun' placeholder="" class="form-control"/>
								</div>
						</div>
						<div class="form-group row m-b-10">
							<label class="col-lg-4 text-lg-right col-form-label">Status Akreditasi</label>
								<div class="col-lg-9 col-xl-3">
									<?php echo buatcombo('kriteria','akreditasi_kriteria','','kriteria','kriteria','',''); ?>	
								</div>
						</div>
