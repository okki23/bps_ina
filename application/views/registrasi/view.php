	...
	<?php if(isset($_POST['submit'])) { ?>
		...
		<p>
			<a href="<?php echo base_url('registrasi/post') ?>" class="btn btn-primary">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div align="center">
					<a href="<?php echo base_url('registrasi/edit/'.$r->id_registrasi) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
