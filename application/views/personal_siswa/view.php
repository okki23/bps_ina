	...
	<div class="panel panel-inverse">
		...
		<?php echo form_open('personal_siswa'); ?>
			<div class="container">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="<?php echo base_url('registrasi/profil/'.$r->id_registrasi) ?>"class="btn btn-warning btn-sm"><i class="fa fa-user"></i></a>
			</td>
		
			<td>
				<div align="center">
					<a href="<?php echo base_url('registrasi/edit_siswa/'.$r->id_registrasi) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
				</div>
			</td>
		</tr>
		<?php $i++;}?>
