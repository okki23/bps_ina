	...
	<div class="panel panel-inverse">
		...
		<?php echo form_open('workshop_tool'); ?>
			<div class="container">
	...
	<?php if(isset($_POST['submit'])) { ?>
		...
		<p>
			<a href="<?php echo base_url('workshop_tool/post') ?>" class="btn btn-primary">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div align="center">
					<a href="<?php echo base_url('workshop_tool/edit/'.$r->id_workshop_tool) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
