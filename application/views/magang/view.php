			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div align="center">
								<a href="<?php echo base_url('magang/edit/'.$r->id_magang) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
								<a href="<?php echo base_url('magang/delete/'.$r->id_magang) ?>"class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>	
							</div>
						</td>
					</tr>
					<?php $i++;}?>
