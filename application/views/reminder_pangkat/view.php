			...
			<table id="example1" class="table table-bordered table-striped">
				<thead>
					<tr>
						...
						<th>NOMOR SK</th>
						<th>ESTIMASI KENAIKAN PANGKAT</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td><?php echo $r->NAMA;?><br>
							...
							<br><?php echo $r->UNITKERJA_SING;?>
						</td>
						<td><?php echo $r->GOL;?></td>
						<td>TMT GOLONGAN : <?php echo tgl_indo($r->GOL_TMT);?><br>
							TGL GOLONGAN : <?php echo tgl_indo($r->gol_tgl);?>
						
						</td>
						<td><?php echo $r->sk_pangkat;?></td>
						<td></td>
					</tr>
					<?php $i++;}?>
					</tbody>
