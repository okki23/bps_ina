	...
	<div class="panel panel-inverse">
		...
		<p>
			<a href="<?php echo base_url('prodi/post') ?>" class="btn btn-primary">
	...
	<table id="example1" class="table table-bordered table-striped">
		<thead>
			<tr>
				...
				<th width="15%">TAHUN PEMBENTUKAN</th>
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $r->tahun_bentuk_prodi;?></td>
				<td><?php echo status_aktif($r->status);?></td>
				<td>
					<div align="center">
						<a href="<?php echo base_url('prodi/edit/'.$r->id_prodi) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
