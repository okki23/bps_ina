	...
	<div class="panel-body">
		...
		<?php
			...
			echo "<input type='hidden' name='id' value='$r[id_prodi]'>";
		?>
						...
						<div class="form-group row m-b-10">
							<label class="col-lg-4 text-lg-right col-form-label">Nama Program Studi/Jurusan</label>
								<div class="col-lg-9 col-xl-6">
									<?php echo inputan('text', 'nama_prodi','','', 1, $r['nama_prodi'],'');?>
								</div>
						</div>
						<div class="form-group row m-b-10">
							<label class="col-lg-4 text-lg-right col-form-label">Tahun Pembentukan Program Studi/Jurusan</label>
								<div class="col-lg-9 col-xl-6">
									<?php echo inputan('text', 'tahun_bentuk_prodi','','', 1, $r['tahun_bentuk_prodi'],'');?>
								</div>
						</div>
						
						
						<div class="form-group row m-b-10"> 
							<label class="col-lg-4 text-lg-right col-form-label">Status</label>
								<div class="col-lg-9 col-xl-6">	
