...
<div class="profile-content">
	<div class="tab-content p-0">
		<div class="tab-pane fade show active" id="profile-post">
			...
			<a href="<?php echo base_url().'dosen/post/'.$r['nipbaru'].'/'.$r['NIP'] ;?>" class="btn btn-primary btn-sm">
				 ...
				 <?php
					...
					<small>
						<tr class="font-size-sm text-muted">
							...
							<td>
								<a href="<?php echo base_url().'personal_dosen/edit/'.$bahan['id_personal_dosen'];?>" class="btn btn-warning btn-sm">
									<i class="fa fa-edit"></i>
								</a>
								<a href="<?php echo base_url().'personal_dosen/delete/'.$bahan['id_personal_dosen'];?>" class="btn btn-danger btn-sm">
		...
		<div class="tab-pane fade" id="profile-friend">
			...
			<a href="<?php echo base_url().'magang/post/'.$r['nipbaru'].'/'.$r['NIP'] ;?>" class="btn btn-primary btn-sm">
				<i class="fa fa-plus"></i>
			</a>		
			<hr>
			<table id="example1" class="table table-bordered table-striped">
				 ...
				 <?php
					...
					<small>
						<tr class="font-size-sm text-muted">
							...
							<td>
								<a href="<?php echo base_url().'magang/edit/'.$mgg['id_magang'];?>" class="btn btn-warning btn-sm">
									<i class="fa fa-edit"></i>
								</a>
								<a href="<?php echo base_url().'magang/delete/'.$mgg['id_magang'];?>" class="btn btn-danger btn-sm">
									<i class="fa fa-trash"></i>
								</a>
							</td>
						</tr>  
